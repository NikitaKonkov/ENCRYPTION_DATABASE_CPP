...
call :CheckAndCompile "test.cpp" "bin/test.obj"
call :CheckAndCompile "core/Datahash.cpp" "bin/Datahash.obj"
call :CheckAndCompile "core/Dataread.cpp" "bin/Dataread.obj"


echo Linking object files to create executable...

REM Link all object files together
link /OUT:test.exe bin\test.obj bin\Datahash.obj bin\Dataread.obj ws2_32.lib
