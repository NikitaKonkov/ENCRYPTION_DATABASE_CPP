...
call :CheckAndCompile "extern/SIMD_Hashing.cpp" "bin/SIMD_Hashing.obj"


echo Linking object files to create executable...

REM Link all object files together
link /OUT:hash.exe bin\SIMD_Hashing.obj ws2_32.lib bcrypt.lib crypt32.lib advapi32.lib
if %errorlevel% neq 0 (
    echo Linking failed!
    exit /b %errorlevel%
)
...
if not exist "!OBJECT_FILE!" (
    ...
    cl /c /EHsc /O2 /std:c++17 /I"extern" "!SOURCE_FILE!" /Fo"!OBJECT_FILE!"
    goto :update_hash
)
